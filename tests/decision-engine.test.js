...
const state={exerciseCatalog:catalog,exerciseRoles:roles,trainingBlocks:blocks,workouts:[...squat,...bench,...dead],workoutRevisions:[]};
...
console.log('v2 decision engine direction, readiness guards and chronology passed');
