...
const withLog={...scheduled,workouts:[...scheduled.workouts,performed]},report=Guidance.inspect(withLog,{asOf,now});console.log('phase guidance debug',JSON.stringify({detail:report.details[0],sum:report.summary,planSource:plan.source,workout:performed.sessionIntent,calendar:item.revisions[0].context.prescription}));
