...
assert.equal(migrated.releaseVersion, require('../package.json').version);
...
assert.deepEqual(migrated.decisionEvents, []);
assert.equal(migrated.decisionFeedbackVersion, 1);
