...
assert.equal(JSON.stringify(original),snapshot,'migration must not mutate imported input');assert.equal(migrated.schemaVersion,16);assert.equal(migrated.releaseVersion,'2.8.0');
