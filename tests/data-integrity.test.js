...
assert.equal(JSON.stringify(original),snapshot,'migration must not mutate imported input');assert.equal(migrated.schemaVersion,15);assert.equal(migrated.releaseVersion,'1.16.0');
