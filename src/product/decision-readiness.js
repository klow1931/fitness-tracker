(function(root,factory){
  ...
  function snapshot(state,{asOf,knownAt,retrospective=false}={}){
    ...
    for(const [lift,label] of Object.entries(LIFTS)){
      ...
      if(primary.length&&metrics.capacityDays<3)reasons.push('Fewer than three capacity-evidence days: low-RPE sets and submaximal singles stay logged but do not estimate capacity.');
