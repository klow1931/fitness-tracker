// ========== Data Layer (IndexedDB + localStorage migration) ==========
    ...
    const DEFAULT_DATA = {
      schemaVersion: 19, programReviews: [], reviewedPrograms: [], athleteGoals: [], scheduledSessions: [], trainingBlocks: [], integrityVersion: 1, readinessVersion: 1, prescriptionVersion: 1,
