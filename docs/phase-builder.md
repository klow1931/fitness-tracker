...
## Mock-meet execution and recap (v2.34)

A **scheduled** meet cycle offers an expandable mock-meet result recorder on its chosen Saturday/Sunday event date or later. Each confirmed competition lift has three athlete-entered attempt slots with outcomes made, missed, passed, or unrecorded. Valid made/missed loads are stored as kg (1–1000 kg, two decimals); UI converts display and input independently of kg storage. The app never selects a meet opener or infers an attempt from training estimates. Bests come only from recorded made attempts, and a three-lift total is withheld until all three lifts have a recorded made attempt. Corrections create dated revisions and do not replace older results. The post-cycle recap summarizes verified, linked training separately from recorded meet attempts. No training prescriptions, completed workout history, or original cycle plans are changed. Existing cycles without meet results remain valid and editable when their event date arrives.
